...
func (c *rateLimiterServiceClient) ShouldAllow(ctx context.Context, in *ShouldAllowRequest, opts ...grpc.CallOption) (*ShouldAllowResponse, error) {
	out := new(ShouldAllowResponse)
	err := c.cc.Invoke(ctx, "/ratelimit.RateLimiterService/ShouldAllow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRateLimiterServiceServer) ShouldAllow(context.Context, *ShouldAllowRequest) (*ShouldAllowResponse, error) {
...
func _RateLimiterService_ShouldAllow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ratelimit.RateLimiterService/ShouldAllow",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RateLimiterServiceServer).ShouldAllow(ctx, req.(*ShouldAllowRequest))
	}
